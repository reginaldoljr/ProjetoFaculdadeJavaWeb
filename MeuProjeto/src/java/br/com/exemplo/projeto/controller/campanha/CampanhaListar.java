 ...
 * @author reginaldo
 */
@WebServlet(name = "CampanhaListar", urlPatterns = {"/CampanhaListar"})
public class CampanhaListar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.setAttribute("campanhas", dao.listar());
            
            request.getRequestDispatcher("/cadastros/campanha/campanha.jsp").forward(request,response);
