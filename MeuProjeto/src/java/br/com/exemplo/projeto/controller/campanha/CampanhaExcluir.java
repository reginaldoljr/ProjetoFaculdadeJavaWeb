 ...
 * @author reginaldo
 */
@WebServlet(name = "CampanhaExcluir", urlPatterns = {"/CampanhaExcluir"})
public class CampanhaExcluir extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (dao.excluir(idCampanha)) {
                mensagem = "Campanha excluida com sucesso";
            } else {
                mensagem = "Problemas ao excluir campanha";
            }
            ...
            System.out.println("Erro ao excluir campanha! Erro: "+ex.getMessage());
            ex.printStackTrace();
        }
    }
