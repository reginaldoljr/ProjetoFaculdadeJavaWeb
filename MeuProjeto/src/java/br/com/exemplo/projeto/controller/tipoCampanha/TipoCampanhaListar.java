 ...
 * @author reginaldo
 */
@WebServlet(name = "TipoCampanhaListar", urlPatterns = {"/TipoCampanhaListar"})
public class TipoCampanhaListar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.setAttribute("tipocampanhas", dao.listar());
            request.getRequestDispatcher("/cadastros/tipoCampanha/tipocampanha.jsp")
